...
export const variantsConfig = defineEntityConfig<Variant>()({
  ...
  // ======================== ROTAS ========================
  routes: {
    list: '/stock/assets/variants',
    detail: '/stock/assets/variants/:id',
    create: '/stock/assets/variants/new',
    edit: '/stock/assets/variants/:id/edit',
  },
