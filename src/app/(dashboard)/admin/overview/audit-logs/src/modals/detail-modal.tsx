                ...
                <table className="w-full table-fixed text-sm">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-white/5 border-b border-gray-200 dark:border-white/10">
                      <th className="text-left px-3 py-2 text-xs font-medium text-gray-500 dark:text-gray-400 w-1/4">
                        Campo
                      </th>
                      <th className="text-left px-3 py-2 text-xs font-medium text-gray-500 dark:text-gray-400 w-[37.5%]">
                        Antes
                      </th>
                      <th className="text-left px-3 py-2 text-xs font-medium text-gray-500 dark:text-gray-400 w-[37.5%]">
                        Depois
                  ...
                  <tbody>
                    {diffs.map(diff => (
                      ...
                      >
                        <td className="px-3 py-2 font-medium text-gray-700 dark:text-gray-300 truncate">
                          {diff.label}
                        </td>
                        <td
                          className={cn(
