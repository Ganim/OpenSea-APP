...
import { Loader2, Plus, ShoppingCart, Undo2 } from 'lucide-react';
...
const ENTRY_TYPE_OPTIONS: {
  ...
  { type: 'PURCHASE', label: 'Compra', icon: ShoppingCart },
  { type: 'CUSTOMER_RETURN', label: 'Devolução de Cliente', icon: Undo2 },
];
              ...
              {ENTRY_TYPE_OPTIONS.map(option => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'flex items-center gap-2 p-2.5 rounded-lg border text-sm font-medium transition-colors text-left',
                      isSelected
