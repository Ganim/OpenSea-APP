  ...
  return (
    <div
      className={cn(
        ...
        isSelected
          ? 'bg-gradient-to-r from-violet-100 to-blue-100 dark:from-sky-500/20 dark:to-sky-500/20 border-emerald-500'
          : 'bg-gradient-to-r from-violet-50 to-blue-50 dark:from-slate-800/50 dark:to-slate-800/50 hover:from-violet-100 hover:to-blue-100 dark:hover:from-slate-700/50 dark:hover:to-slate-700/50 border-border'
      )}
      onClick={onClick}
    >
      {/* Column 1: Cor */}
