...
export interface ItemLabelData extends LabelData {
  sku: string;
  productName: string;
  variantName?: string;
  quantity: number;
...
export interface ItemLabelConfig extends LabelConfig {
  showSku: boolean;
...
export const defaultItemLabelConfig: ItemLabelConfig = {
  ...defaultLabelConfig,
  showSku: true,
