...
export const tagsConfig = defineEntityConfig<Tag>()({
  ...
  routes: {
    list: '/stock/tags',
    detail: '/stock/tags/:id',
    create: '/stock/tags/new',
    edit: '/stock/tags/:id/edit',
  },
  ...
  // ======================== PERMISSÕES ========================
  permissions: {
    view: STOCK_PERMISSIONS.TAGS.READ,
    create: STOCK_PERMISSIONS.TAGS.CREATE,
    update: STOCK_PERMISSIONS.TAGS.UPDATE,
    delete: STOCK_PERMISSIONS.TAGS.DELETE,
    export: STOCK_PERMISSIONS.TAGS.MANAGE,
    import: STOCK_PERMISSIONS.TAGS.MANAGE,
  },
    ...
    header: [
      {
        ...
        icon: Plus,
        variant: 'default',
        permission: STOCK_PERMISSIONS.TAGS.CREATE,
        onClick: () => {},
      },
    ],
    item: [
      {
        ...
        icon: Eye,
        onClick: () => {},
        permission: STOCK_PERMISSIONS.TAGS.READ,
      },
      {
        id: 'edit',
        label: 'Editar',
        icon: Edit,
        onClick: () => {},
        permission: STOCK_PERMISSIONS.TAGS.UPDATE,
      },
      {
        id: 'duplicate',
        label: 'Duplicar',
      ...
      },
      {
        ...
        icon: Trash2,
        onClick: () => {},
        permission: STOCK_PERMISSIONS.TAGS.DELETE,
        confirm: true,
