...
export const manufacturersConfig = defineEntityConfig<Manufacturer>()({
  ...
  permissions: {
    view: STOCK_PERMISSIONS.MANUFACTURERS.ACCESS,
    create: STOCK_PERMISSIONS.MANUFACTURERS.REGISTER,
    update: STOCK_PERMISSIONS.MANUFACTURERS.MODIFY,
    delete: STOCK_PERMISSIONS.MANUFACTURERS.REMOVE,
    export: STOCK_PERMISSIONS.MANUFACTURERS.REMOVE,
    import: STOCK_PERMISSIONS.MANUFACTURERS.REMOVE,
  },
    ...
    header: [
      {
        ...
        icon: Plus,
        variant: 'default',
        permission: STOCK_PERMISSIONS.MANUFACTURERS.REGISTER,
        onClick: () => {},
      },
    ],
    item: [
      ...
      },
      {
        ...
        icon: Edit,
        onClick: () => {},
        permission: STOCK_PERMISSIONS.MANUFACTURERS.MODIFY,
      },
      {
        id: 'duplicate',
        label: 'Duplicar',
      ...
      },
      {
        ...
        icon: Trash2,
        onClick: () => {},
        permission: STOCK_PERMISSIONS.MANUFACTURERS.REMOVE,
        confirm: true,
