          ...
          <>
            <DialogHeader className="border-b pb-4">
              <DialogTitle className="flex items-center gap-3">
                <div className="flex items-center justify-center text-white shrink-0 bg-linear-to-br from-indigo-500 to-blue-600 p-2 rounded-lg">
        ...
        {step === 'results' && companyData && (
          <>
            ...
            <div className="space-y-6 py-6 max-h-96 overflow-y-auto">
              <Card className="p-4 bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-800">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {companyData.qsa.slice(0, 3).map((socio, idx) => (
                          <div
                            key={idx}
                            className="text-sm bg-white dark:bg-slate-800 p-2 rounded border border-indigo-100 dark:border-indigo-900"
                          >
