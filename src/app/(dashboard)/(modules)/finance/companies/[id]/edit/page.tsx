...
export default function FinanceCompanyEditPage() {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      router.push(`/finance/companies/${companyId}`);
    },
    onError: error => {
      logger.error(
      ...
      <PageLayout>
        ...
        <PageBody>
          <Card className="bg-white/5 p-12 text-center">
            ...
            <Button
              onClick={() => router.push('/finance/companies')}
              className="mt-4"
            >
        ...
        <PageActionBar
          breadcrumbItems={[
            ...
            { label: 'Empresas', href: '/finance/companies' },
            {
              ...
              href: `/finance/companies/${companyId}`,
            },
            { label: 'Editar' },
          ]}
          buttons={[
            {
              ...
              title: 'Cancelar',
              icon: X,
              onClick: () => router.push(`/finance/companies/${companyId}`),
              variant: 'outline',
            },
            {
              id: 'save',
