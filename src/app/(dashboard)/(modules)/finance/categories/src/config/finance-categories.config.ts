...
export const financeCategoriesConfig = defineEntityConfig<FinanceCategory>()({
  ...
  permissions: {
    view: FINANCE_PERMISSIONS.CATEGORIES.READ,
    create: FINANCE_PERMISSIONS.CATEGORIES.CREATE,
    update: FINANCE_PERMISSIONS.CATEGORIES.UPDATE,
    delete: FINANCE_PERMISSIONS.CATEGORIES.DELETE,
  },
