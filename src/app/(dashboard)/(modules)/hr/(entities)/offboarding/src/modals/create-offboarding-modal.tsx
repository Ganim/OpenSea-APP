...
export function CreateOffboardingModal({
  ...
  const { data: employeesData, isLoading: isLoadingEmployees } = useQuery({
    queryKey: ['employees', 'offboarding-picker'],
    queryFn: async () => {
  ...
  }, [selectedEmployeeId, title, draftItems, createOffboarding]);
  ...
  const steps: WizardStep[] = [
    {
      ...
      description: 'Defina o título e os itens do checklist de desligamento',
      icon: <ListTodo className="h-16 w-16 text-rose-500/60" />,
      isValid: step1Valid,
      content: (
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Ex: Desligamento Equipe TI, Rescisão Comercial..."
              className="h-9"
              autoFocus
            />
          </div>
            ...
            <ScrollArea className="max-h-[240px]">
              <div className="space-y-2">
                {draftItems.map((item, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center h-6 w-6 rounded-md bg-rose-50 dark:bg-rose-500/10 shrink-0 mt-1">
    ...
    },
    {
      ...
      description: 'Selecione o colaborador para o checklist de desligamento',
                ...
                <div className="space-y-1">
                  {isLoadingEmployees ? (
                    ...
                    filteredEmployees.map((emp: Employee) => (
                      ...
                      >
                        <div className="flex items-center justify-center h-8 w-8 rounded-lg bg-rose-50 dark:bg-rose-500/10 shrink-0">
      ...
      footer: (
        <Button
          ...
          disabled={!step2Valid || createOffboarding.isPending}
        >
          {createOffboarding.isPending ? (
