...
export const employeesConfig = defineEntityConfig<Employee>()({
  ...
  permissions: {
    ...
    create: HR_PERMISSIONS.EMPLOYEES.REGISTER,
    update: HR_PERMISSIONS.EMPLOYEES.MODIFY,
    delete: HR_PERMISSIONS.EMPLOYEES.REMOVE,
    ...
    header: [
      {
        ...
        icon: Plus,
        variant: 'default',
        permission: HR_PERMISSIONS.EMPLOYEES.REGISTER,
        onClick: () => {},
      },
    ],
    item: [
      ...
      },
      {
        ...
        icon: Edit,
        onClick: () => {},
        permission: HR_PERMISSIONS.EMPLOYEES.MODIFY,
      },
      {
        id: 'duplicate',
        label: 'Duplicar',
      ...
      },
      {
        ...
        icon: Trash2,
        onClick: () => {},
        permission: HR_PERMISSIONS.EMPLOYEES.REMOVE,
        confirm: true,
