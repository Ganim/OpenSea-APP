...
export const vacationsConfig = defineEntityConfig<VacationPeriod>()({
  ...
  permissions: {
    view: HR_PERMISSIONS.VACATIONS.ACCESS,
    create: HR_PERMISSIONS.VACATIONS.REGISTER,
    update: HR_PERMISSIONS.VACATIONS.MODIFY,
    delete: HR_PERMISSIONS.VACATIONS.MODIFY,
    export: HR_PERMISSIONS.VACATIONS.ADMIN,
    import: HR_PERMISSIONS.VACATIONS.ADMIN,
  },
    ...
    header: [
      {
        ...
        icon: Plus,
        variant: 'default',
        permission: HR_PERMISSIONS.VACATIONS.REGISTER,
        onClick: () => {},
      },
    ],
    item: [
      {
        ...
        icon: Eye,
        onClick: () => {},
        permission: HR_PERMISSIONS.VACATIONS.ACCESS,
      },
      {
        id: 'schedule',
        label: 'Agendar',
        icon: CalendarDays,
        onClick: () => {},
        permission: HR_PERMISSIONS.VACATIONS.MODIFY,
      },
      {
        id: 'sell',
        label: 'Vender Dias',
