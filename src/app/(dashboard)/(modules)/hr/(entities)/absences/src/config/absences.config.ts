...
export const absencesConfig = defineEntityConfig<Absence>()({
  ...
  permissions: {
    view: HR_PERMISSIONS.ABSENCES.READ,
    create: HR_PERMISSIONS.ABSENCES.CREATE,
    update: HR_PERMISSIONS.ABSENCES.UPDATE,
    delete: HR_PERMISSIONS.ABSENCES.DELETE,
    export: HR_PERMISSIONS.ABSENCES.MANAGE,
    import: HR_PERMISSIONS.ABSENCES.MANAGE,
  },
    ...
    header: [
      {
        ...
        icon: Plus,
        variant: 'default',
        permission: HR_PERMISSIONS.ABSENCES.CREATE,
        onClick: () => {},
      },
    ],
    item: [
      {
        ...
        icon: Eye,
        onClick: () => {},
        permission: HR_PERMISSIONS.ABSENCES.READ,
      },
      {
        id: 'approve',
        label: 'Aprovar',
        icon: Check,
        onClick: () => {},
        permission: HR_PERMISSIONS.ABSENCES.APPROVE,
      },
      {
        id: 'reject',
        label: 'Rejeitar',
