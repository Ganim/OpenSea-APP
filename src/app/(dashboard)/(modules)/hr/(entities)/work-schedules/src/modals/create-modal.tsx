...
export function CreateModal({
  ...
  const stepIdentificationValid = name.trim().length >= 2;
  const canSubmit = stepIdentificationValid && enabledDaysCount > 0;
  ...
  const steps: WizardStep[] = [
    ...
    {
      title: 'Identificação',
      description: 'Defina o nome da escala, intervalo e modo de replicação.',
      icon: <Clock className="h-16 w-16 text-sky-400" strokeWidth={1.2} />,
      isValid: stepIdentificationValid,
      content: (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-32 h-9 text-sm pr-10"
                />
              ...
              <p className="text-[11px] text-muted-foreground">
                Duração do intervalo descontado da jornada diária.
              </p>
            </div>
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="h-9 flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">
                  Ao editar segunda-feira, replica horário para os demais dias
                  úteis.
                </span>
              </div>
            </div>
    ...
    // -------- Step 2: Jornada Semanal --------
    {
      title: 'Jornada Semanal',
      description: 'Defina horários e folgas para cada dia da semana.',
      icon: (
        <CalendarDays className="h-16 w-16 text-sky-400" strokeWidth={1.2} />
      ),
      isValid: enabledDaysCount > 0,
      content: (
        <div className="space-y-4 py-2">
          {/* Day rows */}
          <div className="space-y-1">
            {WEEK_DAYS.map(day => {
              ...
              return (
                <div
                  key={day}
                  className={`flex items-center gap-2 h-10 px-2 rounded-lg border transition-colors ${
                    d.enabled
