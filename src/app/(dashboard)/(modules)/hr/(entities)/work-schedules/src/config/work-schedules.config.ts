...
export const workSchedulesConfig = defineEntityConfig<WorkSchedule>()({
  ...
  // ======================== PERMISSÕES ========================
  permissions: {
    view: HR_PERMISSIONS.WORK_SCHEDULES.READ,
    create: HR_PERMISSIONS.WORK_SCHEDULES.CREATE,
    update: HR_PERMISSIONS.WORK_SCHEDULES.UPDATE,
    delete: HR_PERMISSIONS.WORK_SCHEDULES.DELETE,
    export: HR_PERMISSIONS.WORK_SCHEDULES.MANAGE,
    import: HR_PERMISSIONS.WORK_SCHEDULES.MANAGE,
  },
    ...
    header: [
      {
        ...
        icon: Plus,
        variant: 'default',
        permission: HR_PERMISSIONS.WORK_SCHEDULES.CREATE,
        onClick: () => {},
      },
    ],
    item: [
      {
        ...
        icon: Eye,
        onClick: () => {},
        permission: HR_PERMISSIONS.WORK_SCHEDULES.READ,
      },
      {
        id: 'edit',
        label: 'Editar',
        icon: Edit,
        onClick: () => {},
        permission: HR_PERMISSIONS.WORK_SCHEDULES.UPDATE,
      },
      {
        id: 'duplicate',
        label: 'Duplicar',
      ...
      },
      {
        ...
        icon: Trash2,
        onClick: () => {},
        permission: HR_PERMISSIONS.WORK_SCHEDULES.DELETE,
        confirm: true,
