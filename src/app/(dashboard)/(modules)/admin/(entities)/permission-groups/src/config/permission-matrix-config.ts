...
export const MATRIX_TABS: MatrixTab[] = [
  ...
  // ── Tab 4: Vendas ───────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { label: 'Pedidos', group: 'Pedidos e Orçamentos', backendResources: ['sales.orders'],
        availableActions: ['access', 'register', 'modify', 'remove', 'export', 'print', 'admin', 'onlyself'] },
      { label: 'Orçamentos', group: 'Pedidos e Orçamentos', backendResources: ['sales.quotes'],
        availableActions: ['access', 'register', 'modify', 'remove', 'print', 'onlyself'] },
      { label: 'Devoluções', group: 'Pedidos e Orçamentos', backendResources: ['sales.returns'],
        availableActions: ['access', 'register', 'admin'] },
      // Preços e Promoções
      { label: 'Promoções', group: 'Preços e Promoções', backendResources: ['sales.promotions'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Tabelas de Preço', group: 'Preços e Promoções', backendResources: ['sales.price-tables'],
        availableActions: ['access', 'register', 'modify', 'remove', 'admin'] },
      { label: 'Preços de Cliente', group: 'Preços e Promoções', backendResources: ['sales.customer-prices'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Descontos', group: 'Preços e Promoções', backendResources: ['sales.discounts'],
        availableActions: ['access', 'admin'] },
      { label: 'Cupons', group: 'Preços e Promoções', backendResources: ['sales.coupons'],
        availableActions: ['access', 'register', 'remove', 'admin'] },
      { label: 'Combos', group: 'Preços e Promoções', backendResources: ['sales.combos'],
        availableActions: ['access', 'register', 'remove', 'admin'] },
      { label: 'Campanhas', group: 'Preços e Promoções', backendResources: ['sales.campaigns'],
        availableActions: ['access', 'register', 'modify', 'remove', 'admin'] },
      // PDV e Caixa
      { label: 'PDV', group: 'PDV e Caixa', backendResources: ['sales.pos'],
        availableActions: ['access', 'admin', 'onlyself'] },
      { label: 'Caixa', group: 'PDV e Caixa', backendResources: ['sales.cashier'],
        availableActions: ['access', 'admin'] },
      { label: 'Comissões', group: 'PDV e Caixa', backendResources: ['sales.commissions'],
        availableActions: ['access', 'admin', 'onlyself'] },
      // Licitações
      ...
      { label: 'Propostas de Licitação', group: 'Licitações', backendResources: ['sales.bid-proposals'],
        availableActions: ['access', 'admin'] },
      { label: 'Bot de Licitação', group: 'Licitações', backendResources: ['sales.bid-bot'],
        availableActions: ['access', 'admin'] },
      { label: 'Contratos de Licitação', group: 'Licitações', backendResources: ['sales.bid-contracts'],
        availableActions: ['access', 'register', 'admin'] },
      { label: 'Documentos de Licitação', group: 'Licitações', backendResources: ['sales.bid-documents'],
        availableActions: ['access', 'register', 'modify', 'remove', 'admin'] },
      { label: 'Empenhos', group: 'Licitações', backendResources: ['sales.bid-empenhos'],
        availableActions: ['access', 'register', 'modify'] },
      // Catálogos e Conteúdo
      { label: 'Catálogos', group: 'Catálogos e Conteúdo', backendResources: ['sales.catalogs'],
        availableActions: ['access', 'register', 'modify', 'remove', 'admin'] },
      { label: 'Conteúdo', group: 'Catálogos e Conteúdo', backendResources: ['sales.content'],
        availableActions: ['access', 'register', 'remove', 'admin'] },
      { label: 'Identidade Visual', group: 'Catálogos e Conteúdo', backendResources: ['sales.brand'],
        availableActions: ['access', 'modify'] },
      { label: 'Portal do Cliente', group: 'Catálogos e Conteúdo', backendResources: ['sales.customer-portal'],
        availableActions: ['access', 'register', 'remove'] },
      // Marketplaces
      { label: 'Marketplaces: Conexões', group: 'Marketplaces', backendResources: ['sales.marketplace-connections'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Marketplaces: Anúncios', group: 'Marketplaces', backendResources: ['sales.marketplace-listings'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Marketplaces: Pedidos', group: 'Marketplaces', backendResources: ['sales.marketplace-orders'],
        availableActions: ['access', 'modify'] },
      { label: 'Marketplaces: Pagamentos', group: 'Marketplaces', backendResources: ['sales.marketplace-payments'],
        availableActions: ['access'] },
      { label: 'Marketplaces (geral)', group: 'Marketplaces', backendResources: ['sales.marketplaces'],
        availableActions: ['access', 'admin'] },
      // Analytics
      { label: 'Analytics', group: 'Analytics', backendResources: ['sales.analytics'],
        availableActions: ['access', 'export', 'admin', 'onlyself'] },
      { label: 'Metas', group: 'Analytics', backendResources: ['sales.analytics-goals'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Relatórios', group: 'Analytics', backendResources: ['sales.analytics-reports'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Dashboards', group: 'Analytics', backendResources: ['sales.analytics-dashboards'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      { label: 'Rankings', group: 'Analytics', backendResources: ['sales.analytics-rankings'],
        availableActions: ['access'] },
    ],
  },
  ...
  // ── Tab 6: Ferramentas ──────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { label: 'Arquivos', group: 'Arquivos', backendResources: ['tools.storage.files'],
        availableActions: ['access', 'register', 'modify', 'remove', 'admin', 'share', 'onlyself'] },
      // Assinatura Digital
      { label: 'Envelopes', group: 'Assinatura Digital', backendResources: ['tools.signature.envelopes'],
        availableActions: ['access', 'register', 'modify', 'remove', 'admin'] },
      { label: 'Certificados', group: 'Assinatura Digital', backendResources: ['tools.signature.certificates'],
        availableActions: ['access', 'register', 'remove', 'admin'] },
      { label: 'Templates de Assinatura', group: 'Assinatura Digital', backendResources: ['tools.signature.templates'],
        availableActions: ['access', 'register', 'modify', 'remove'] },
      // IA
      { label: 'Chat IA', group: 'Inteligência Artificial', backendResources: ['tools.ai.chat'],
        availableActions: ['access'] },
      { label: 'Insights IA', group: 'Inteligência Artificial', backendResources: ['tools.ai.insights'],
        availableActions: ['access'] },
      { label: 'Configuração IA', group: 'Inteligência Artificial', backendResources: ['tools.ai.config'],
        availableActions: ['access', 'modify'] },
      { label: 'Favoritos IA', group: 'Inteligência Artificial', backendResources: ['tools.ai.favorites'],
        availableActions: ['access', 'register', 'remove'] },
      { label: 'Ações IA', group: 'Inteligência Artificial', backendResources: ['tools.ai.actions'],
        availableActions: ['access'] },
    ],
  },
