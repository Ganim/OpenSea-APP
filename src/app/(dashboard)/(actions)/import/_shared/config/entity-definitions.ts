...
const variantFields: EntityFieldDefinition[] = [
  ...
  },
  {
    ...
    type: 'text',
    required: false,
    description: 'Cor secundária em formato hexadecimal (ex: #00FF00)',
    validation: {
      maxLength: 7,
      pattern: '^#[0-9A-Fa-f]{6}$',
      patternMessage: 'Formato inválido. Use #RRGGBB',
  ...
  {
    key: 'secondaryColorPantone',
    label: 'Cor Secundária Pantone',
    type: 'text',
    required: false,
    description: 'Código Pantone da cor secundária',
    validation: { maxLength: 50 },
  },
  {
    key: 'pattern',
    label: 'Padrão / Estampa',
    type: 'select',
    required: false,
    description: 'Padrão visual do tecido',
    options: [
      { value: 'SOLID', label: 'Liso' },
      { value: 'STRIPED', label: 'Listrado' },
      { value: 'PLAID', label: 'Xadrez' },
      { value: 'PRINTED', label: 'Estampado' },
