...
export default function ImportManufacturersPage() {
  ...
  const entityDef = ENTITY_DEFINITIONS.manufacturers;

  // Build fields for manufacturer import - stable reference
  const enabledFields = useMemo(() => {
    const baseFields = getEntityFields('manufacturers');
        ...
        <CardContent className="flex items-center gap-4 py-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              Os dados dos fabricantes serão consultados automaticamente na base
              da Receita Federal via BrasilAPI. O CNPJ pode ser informado com ou
        ...
        <CardContent className="flex items-center justify-between py-3">
          <div className="flex items-center gap-4">
            <Badge variant="outline" className="gap-1">
              ...
              {spreadsheet.filledRowCount === 1 ? 'fabricante' : 'fabricantes'}{' '}
              para importar
            </Badge>
            {validationResult &&
