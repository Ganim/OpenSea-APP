      ...
      <Card className="mb-4 border-violet-500/30 bg-violet-500/5">
        <CardContent className="flex items-center gap-4 py-4">
          ...
          <div className="flex-1">
            <h3 className="font-semibold">Importa\u00e7\u00e3o de Templates</h3>
            <p className="text-sm text-muted-foreground">
              Preencha a planilha com os dados dos templates ou cole dados de
        ...
        <CardContent className="flex items-center justify-between py-3">
          <div className="flex items-center gap-4">
            <Badge variant="outline" className="gap-1">
              ...
              {spreadsheet.filledRowCount === 1 ? 'template' : 'templates'} para
              importar
            </Badge>
            {validationResult &&
