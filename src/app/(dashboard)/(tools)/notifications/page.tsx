...
import type { BackendNotification, NotificationType, NotificationPriority } from '@/types/admin';
...
function resolveVisual(n: BackendNotification): NotificationVisual {
  switch (n.entityType) {
    case 'email_message':
      return { icon: Mail, gradient: 'from-blue-500 to-blue-600', bgMuted: 'bg-blue-100 dark:bg-blue-500/10' };
    case 'email_account':
      return { icon: Inbox, gradient: 'from-blue-400 to-blue-500', bgMuted: 'bg-blue-100 dark:bg-blue-500/10' };
    case 'CALENDAR_EVENT':
      return { icon: Calendar, gradient: 'from-emerald-500 to-emerald-600', bgMuted: 'bg-emerald-100 dark:bg-emerald-500/10' };
    case 'calendar_invite':
      return { icon: Calendar, gradient: 'from-purple-500 to-purple-600', bgMuted: 'bg-purple-100 dark:bg-purple-500/10' };
    case 'finance_entry':
      return { icon: DollarSign, gradient: 'from-yellow-500 to-yellow-600', bgMuted: 'bg-yellow-100 dark:bg-yellow-500/10' };
    case 'sales_order':
      return { icon: ShoppingCart, gradient: 'from-green-500 to-green-600', bgMuted: 'bg-green-100 dark:bg-green-500/10' };
    case 'stock_item':
      return { icon: Package, gradient: 'from-orange-500 to-orange-600', bgMuted: 'bg-orange-100 dark:bg-orange-500/10' };
    case 'hr_employee':
      return { icon: Users, gradient: 'from-pink-500 to-pink-600', bgMuted: 'bg-pink-100 dark:bg-pink-500/10' };
    default:
      break;
  }
  switch (n.type) {
    case 'WARNING':
      return { icon: AlertTriangle, gradient: 'from-orange-500 to-orange-600', bgMuted: 'bg-orange-100 dark:bg-orange-500/10' };
    case 'ERROR':
      return { icon: AlertTriangle, gradient: 'from-red-500 to-red-600', bgMuted: 'bg-red-100 dark:bg-red-500/10' };
    case 'SUCCESS':
      return { icon: Check, gradient: 'from-green-500 to-green-600', bgMuted: 'bg-green-100 dark:bg-green-500/10' };
    case 'REMINDER':
      return { icon: Calendar, gradient: 'from-purple-500 to-purple-600', bgMuted: 'bg-purple-100 dark:bg-purple-500/10' };
    default:
      return { icon: Bell, gradient: 'from-slate-500 to-slate-600', bgMuted: 'bg-slate-100 dark:bg-slate-500/10' };
  }
}
...
export default function NotificationsPage() {
  ...
  const hasActiveFilters = readFilter !== 'all' || typeFilter !== 'all' || priorityFilter !== 'all';
          ...
          <div className="bg-muted/30 dark:bg-white/5 rounded-lg px-3 py-2">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="ml-auto text-xs text-muted-foreground">
                {total} {total !== 1 ? 'notificações' : 'notificação'} · {unreadCount} não {unreadCount !== 1 ? 'lidas' : 'lida'}
              </div>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <Badge variant="outline" className={`text-[10px] ${priorityColors[n.priority]}`}>
