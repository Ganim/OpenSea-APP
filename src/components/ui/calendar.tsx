...
function CalendarDayButton({
  ...
  return (
    <button
      ...
      className={cn(
        'flex aspect-square size-auto w-full min-w-(--cell-size) flex-col items-center justify-center gap-1 rounded-md text-sm font-normal leading-none cursor-pointer select-none transition-colors',
