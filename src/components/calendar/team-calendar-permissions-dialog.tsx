            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    borderColor: disabled ? 'var(--border)' : `${bgColor}20`,
                  }}
                >
                  <div
                ...
                <div className="px-4 py-3 space-y-2.5">
                  ...
                  <div
                    className="flex items-center gap-2.5 pb-2.5 border-b border-dashed"
                    style={{
                      borderColor: disabled ? 'var(--border)' : `${bgColor}20`,
                    }}
                  >
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                    {EVENT_PERMISSIONS.map(
                      ({ key: perm, label: permLabel, icon: PermIcon }) => {
